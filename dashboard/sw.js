// Mavis Stock Tracker - Service Worker (v8)
...
// v8: mobile 装饰重排布 (Hero 4 角 96→64, Holding 卡左边框 6→5, 数字 48-56, tooltip bottom) — 装饰元素不减少

const CACHE_NAME = 'mavis-dashboard-v8';
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
